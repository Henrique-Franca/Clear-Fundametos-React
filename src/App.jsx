...
import Mega from './conponents/mega/Mega';
...
export default _ =>                                                                                           
    ...
    <div className='App'>
        ...
        <div className="Cards">
            ...
            <Cards titulo="#12 - Mega" color="purple">
                <Mega qtde={8}/>    
                
            </Cards> 

            <Cards titulo="#11 - Contador" color="orange">
                <Contador numeroInicial={100}/>    
                
            </Cards> 

            <Cards titulo="#10 - Componente Controlado (Input)" color="red">
                <Input/>    
